          ...
          <div className="container bg-light p-5 border shadow-lg">
            <div className="row">
              <div className="col-md-6 offset-md-3 text-center">
                        <input type="text" class="form-control py-3" id="" placeholder="Add Service Name" />
                        <button type="submit" class="btn btn-primary mt-2">Save</button>
                        <hr className='my-5' />
                        <span className='text-success text-center fw-bold py-2 fs-5 d-block'>Successfully added the new service</span>
