  ...
  return (
    <>
      ...
      <div className="container my-md-5 py-md-4">
        <div className="row">
          <div className="col-md-6"><Title title="Careers Details" /></div>
          <div className="col-md-6 text-end">
            <Link to="/careers" className="btn btn-secondary"><i class="fa fa-chevron-left me-2" aria-hidden="true"></i> Back </Link>
          </div>
        </div>
        ...
        <div className="row mt-4">
          <div className="col-md-9 px-4">
            <JobBriefDetails />
            <div className="mt-4">
            <p>Peridot is seeking to hire a Business Analyst to support a Federal client in an upcoming effort in Washington DC. Interested candidates, please reply with resume, desired salary, and contact info to karunalatha.gadamsetti@peridotsolutions.com.</p>
            ...
            <Title title="Requirements Documentation" cssClass="fs-5 fw-bold" />
            <p>
            ...
            <Title title="Pre-Solicitation Documentation" cssClass="fs-5 fw-bold"/>
            <p>
            ...
            <div className="mt-3">
                <span className="d-block"><strong>Department</strong> : Engineering - Software & QA</span>
                <span className="d-block"><strong>Employment Type</strong>:  Full Time, Permanent</span>
            </div>
            </div>
            </div>
          <div className="col-md-3"><JobCurrentOpenings /></div>
        </div>
